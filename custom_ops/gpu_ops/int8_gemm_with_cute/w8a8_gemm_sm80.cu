             ...
             cudaStream_t stream = 0)
{
  ...
  TiledCopy copyA = make_tiled_copy(Copy_Atom<SM80_CP_ASYNC_CACHEALWAYS<uint32_t>, int8_t>{},
                                    Layout<Shape<_32,_8>,Stride<_8,_1>>{},  // Thr layout 32x8 k-major
                                    Layout<Shape< _4,_1>>{});               // Val layout  4x1 k-major
  TiledCopy copyB = make_tiled_copy(Copy_Atom<SM80_CP_ASYNC_CACHEALWAYS<uint32_t>, int8_t>{},
                                    Layout<Shape<_32,_8>,Stride<_8,_1>>{},  // Thr layout 32x8 k-major
